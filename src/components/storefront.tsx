...
function Experience({ products, departments }: { products: Product[]; departments: Department[] }) {
  ...
  return <main>
    ...
    <ProductModal key={selected?.id ?? "closed"} product={selected} onClose={() => setSelected(null)} onAuth={askAuth} onBag={() => setBagOpen(true)}/>
